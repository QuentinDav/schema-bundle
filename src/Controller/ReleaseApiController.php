...
use Qd\SchemaBundle\Dto\CreateReleaseDto;
...
final class ReleaseApiController
{
    ...
    public function create(Request $request): JsonResponse
    {
        ...
        $dto = new CreateReleaseDto(
            versionType: $payload['version_type'] ?? '',
        ...
        try {
            $name = $this->versioningService->getNextVersion(
                $dto->versionType === 'auto' ? 'minor' : $dto->versionType
            );
            ...
            $result = $this->snapshotService->createRelease($name, $dto->description);
    ...
    public function get(int $id): JsonResponse
    {
        ...
        foreach ($release->getSnapshots() as $snapshot) {
            ...
            } elseif ($this->schemaDiff->isEmpty($snapshot->getDiffJson())) {
